...
import { TestHelpers, type Marketplace_AssetAddedEvent } from 'generated';
...
describe('Marketplace contract AssetAddedEvent event tests', () => {
    ...
    const event = Marketplace.AssetAddedEvent.mock({
    ...
    it('Marketplace_AssetAddedEvent is created correctly', async () => {
        ...
        const actualMarketplaceAssetAddedEvent =
            mockDbUpdated.entities.Marketplace_AssetAddedEvent.get(
        ...
        assert.deepEqual(
            actualMarketplaceAssetAddedEvent,
            expectedMarketplaceAssetAddedEvent,
            'Actual MarketplaceAssetAddedEvent should be the same as the expectedMarketplaceAssetAddedEvent'
        );
    });
});
