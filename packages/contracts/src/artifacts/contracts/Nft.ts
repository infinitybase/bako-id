...
export enum MintErrorInput {
  CannotMintMoreThanOneNFTWithSubId = 'CannotMintMoreThanOneNFTWithSubId',
  MaxNFTsMinted = 'MaxNFTsMinted',
  NFTAlreadyMinted = 'NFTAlreadyMinted',
}
...
export class Nft extends Contract {
  ...
  declare functions: {
    ...
    set_decimals: InvokeFunction<
      [_asset: AssetIdInput, _decimals: BigNumberish],
      void
    >;
    ...
    set_metadata: InvokeFunction<
      [asset: AssetIdInput, key: StdString, metadata: MetadataInput],
      void
    >;
  };
